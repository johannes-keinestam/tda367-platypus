 ...
 * Displays them in rows dynamically using external class WrapLayout.
...
public class BatchThumbPanel extends javax.swing.JPanel implements PropertyChangeListener {
     ...
     * adding ThumbnailImages to the list, as well as the initial "Browse
     * for images" button.
     *
     * @param addToList panel to add
     */
     ...
     *
     * @param img the BatchImage to remove
     */
     ...
     * thread (to prevent freezing). Called when the user chooses files from
     * the file chooser or drag and drop.
     *
     * @param array list of files to add
     */
     ...
     * when new preview is chosen, so that the user cannot select more than
     * one preview at a time.
     *
     * @param img the ThumbnailImage to set as preview
     */
