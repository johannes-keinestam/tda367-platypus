...
public class AddFilterPanel extends javax.swing.JPanel {
    ...
    public void updateList() {
    	jList1.setModel(parentView.getGUICtrl().getNewFilterList());
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(edu.chalmers.platypus.view.gui.PlatypusApp.class).getContext().getResourceMap(AddFilterPanel.class);
